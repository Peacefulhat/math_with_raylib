...
Color colorArray[] = {
    RED,          // Index 0 - Bright Red
    GREEN,        // Index 1 - Bright Green
    BLUE,         // Index 2 - Bright Blue
    YELLOW,       // Index 3 - Bright Yellow
    ORANGE,       // Index 4 - Bright Orange
    PINK,         // Index 5 - Bright Pink
    PURPLE,       // Index 6 - Bright Purple
    SKYBLUE,      // Index 7 - Bright Sky Blue
    LIME,         // Index 8 - Bright Lime
    VIOLET        // Index 9 - Bright Violet
};
